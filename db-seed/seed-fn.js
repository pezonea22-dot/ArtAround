...
module.exports = async function seedFn(mongoose) {
  const User = mongoose.model('User')
  const MuseumObject = mongoose.model('MuseumObject')
  ...
  await Visit.insertMany([
    ...
    },
    {
      ...
      steps: [
        ...
        { objectId: obj('estense-005'), items: getItems('estense-005', ['infantile']) },
        { objectId: obj('estense-006'), items: getItems('estense-006', ['infantile']) },
        { objectId: obj('estense-007'), items: getItems('estense-007', ['infantile']) },
        { objectId: obj('estense-009'), items: getItems('estense-009', ['infantile']) },
        { objectId: obj('estense-010'), items: getItems('estense-010', ['infantile']) },
        { objectId: obj('estense-011'), items: getItems('estense-011', ['infantile']) },
        { objectId: obj('estense-012'), items: getItems('estense-012', ['infantile']) },
      ]
    },
    {
      ...
      museumId: 'galleria-estense', author: autore2._id, targetLevel: 'semplice',
